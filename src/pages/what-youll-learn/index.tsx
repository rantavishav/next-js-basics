  ...
  return (
    <main className="main-section">
      <div className="table-content-wrapper">
        <h1 className="css-1uk1gs8">What you&apos;ll learn</h1>
        <p>
          Next.js is full of goodies, and we won&apos;t be covering every single
          corner of it. We will be going over the Next.js architecture and how
          it works. Also, we will be going over the basic concepts of Next.js
          and there implementations.
        </p>

        <p>
          <strong>So here&apos;s what we&apos;ll be covering</strong>:
        </p>
